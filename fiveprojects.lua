...
RegisterCommand("car", function(source, args, rawCommand)
    ...
    CreateThread(function()
        ...
        local plate = args[2] or "FiveProjecs MENU"
...

{
    ...
    renders = {
        ...
        ["MainInterface"] = {txd = "main-interface", txn = "main-interface", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=FiveProjecsFundo", width = 1217, height = 864},

        ["Menu-Box"] = {txd = "menu-box", txn = "menu-box", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=menu-box", width = 1217, height = 864},

        ["Tab-Anim"] = {txd = "tab-anim", txn = "tab-anim", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=TabAnim", width = 1217, height = 864},

        ["Button"] = {txd = "psycho-button", txn = "psycho-button", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=button", width = 1217, height = 864},

        ["KeyBoard"] = {txd = "keyboard", txn = "keyboard", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=keyboard", width = 1217, height = 864},

        ["Toggle-set"] = {txd = "toggle-set", txn = "toggle-set", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=checkbox", width = 1360, height = 768},

        ["ListAdm"] = {txd = "ListAdm", txn = "ListAdm", url = "https://frolicking-treacle-fef6ca.netlify.app/?image=AdminList", width = 310, height = 51},
...
--[[             yvalue = yvalue + addbutton
            ...
            if yvalue >= 0.34 and yvalue <= max then
                ...
                interact.togglebox(listaadm, "Lista Staffs Próximos", 0.43, yvalue, function ()
                    ...
                    --local table = {"FiveProjecs Discord", "Admnistrador", "Pichau Gamer"}
        ...
        blockveh = function(vehicle,ped)
            ...
            if ped then
                ...
                if IsPedInAnyVehicle(ped, 0) then
                    ...
                    SetVehicleNumberPlateText(vehicle, 'FiveProjecsMENU')
